...
DECLARE 
	...
	--기본데이터 타입과 참조형 데이터 타입들을 모두 사용할 수 있다.
		SNO VARCHAR2(8) NOT NULL := '111111',
	...
	--위에 선언한 레코드 자료형으로 변수를 하나선언해야 실행부에서 레코드를 사용할 수 있다.
	--레코드 자료형의 변수 선언 
	STUDENTREC STUDENT_REC;
BEGIN 
	STUDENTREC.SNO := '222222';
